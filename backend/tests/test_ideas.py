...
def test_get_idea_dedupes_node_metadata(client, fake_es, seed_idea):
    """A-Optimierung: node_metadata wird für eine io-Idee nur EINMAL geholt
    (Rating/Owner + Anhang aus demselben Call, parallel zu den Kommentaren),
    nicht doppelt wie vorher."""
